...
mod tests {
    ...
    fn test_data_processor_operations() {
        ...
        let record1 = Record::new(1, "Item1".to_string(), 10.0, true);
    ...
    fn test_csv_operations() -> Result<(), Box<dyn Error>> {
        ...
        let record1 = Record::new(1, "Alpha".to_string(), 15.5, true);
        let record2 = Record::new(2, "Beta".to_string(), 25.3, false);
        ...
        assert_eq!(new_processor.calculate_total(), 40.8);
