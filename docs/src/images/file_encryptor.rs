...
mod tests {
    ...
    fn test_encryption_decryption() {
        ...
        encrypt_file(temp_input.path(), temp_encrypted.path(), Some(0x55)).unwrap();
        decrypt_file(temp_encrypted.path(), temp_decrypted.path(), Some(0x55)).unwrap();
    ...
    fn test_default_key() {
        ...
        encrypt_file(temp_input.path(), temp_output.path(), None).unwrap();
