...
mod tests {
    ...
    fn test_data_processor() {
        ...
        processor.records.push(DataRecord::new(2, "Item2".to_string(), 20.0, "CategoryB".to_string()));
...
mod tests {
    ...
    fn test_processing_pipeline() {
        ...
        let result = processor.process_pipeline("  test@domain.com  ".to_string(), operations);
        assert_eq!(result.unwrap(), "TEST@DOMAIN.COM");
    }
}