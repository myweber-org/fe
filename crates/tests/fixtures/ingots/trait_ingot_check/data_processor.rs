...
mod tests {
    ...
    fn test_data_processor() {
        ...
        processor.records.push(DataRecord::new(1, 10.0, "A".to_string(), "timestamp".to_string()));
        processor.records.push(DataRecord::new(2, 20.0, "B".to_string(), "timestamp".to_string()));
...
mod tests {
    ...
    fn test_process_valid_data() {
        ...
        writeln!(temp_file, "2,ItemB,20.3,CategoryY").unwrap();
