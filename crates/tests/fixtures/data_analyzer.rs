...
mod tests {
    ...
    fn test_empty_data() {
        ...
        assert_eq!(analyzer.calculate_mean(&empty_data), None);
        assert_eq!(analyzer.calculate_median(empty_data.clone()), None);
        assert_eq!(analyzer.calculate_mode(&empty_data), None);
    }
}