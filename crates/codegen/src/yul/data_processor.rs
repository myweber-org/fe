...
mod tests {
    ...
    fn test_data_processor() {
        ...
        writeln!(temp_file, "3,invalid,TypeA").unwrap();
        writeln!(temp_file, "4,40.5,TypeA").unwrap();
        ...
        let expected_avg = (25.5 + 30.0 + 40.5) / 3.0;
        assert!((average.unwrap() - expected_avg).abs() < 0.001);
