...
pub fn parse_log_file<P: AsRef<Path>>(path: P) -> Result<Vec<LogEntry>, std::io::Error> {
...
pub fn analyze_logs<P: AsRef<Path>>(path: P) -> Result<LogSummary, std::io::Error> {
...
mod tests {
    ...
    #[test]
    fn test_analyze_logs() -> Result<(), std::io::Error> {
        ...
        writeln!(temp_file, "2023-10-01T12:02:00 INFO User logged in")?;
