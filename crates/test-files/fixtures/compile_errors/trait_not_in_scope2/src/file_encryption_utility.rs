...
mod tests {
    ...
    fn test_xor_cipher() {
        ...
        let processed = cipher.process_bytes(original_text);
        let restored = cipher.process_bytes(&processed);
        
        assert_eq!(original_text.to_vec(), restored);
    }
...
mod tests {
    ...
    #[test]
    fn test_encryption_decryption() {
        let encryptor = FileEncryptor::from_password("test_password").unwrap();
