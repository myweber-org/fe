...
mod tests {
    ...
    fn test_parse_string() {
        ...
        let mut parser = JsonParser::new(r#""escaped \"quote\"""#);
        assert_eq!(
            parser.parse(),
            Ok(JsonValue::String(r#"escaped "quote""#.to_string()))
        );
    }
...
mod tests {
    ...
    fn test_parse_number() {
        let mut parser = JsonParser::new("42");
        assert_eq!(parser.parse(), Some(JsonValue::Number(42.0)));

        let mut parser = JsonParser::new("-3.14");
        assert_eq!(parser.parse(), Some(JsonValue::Number(-3.14)));
    }
