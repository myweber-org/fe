...
mod tests {
    ...
    fn test_encryption_roundtrip() {
        ...
        assert_eq!(test_data.as_slice(), decrypted_content);
    }
}
...
fn main() -> io::Result<()> {
    ...
    fs::write(original_file, b"Sample confidential data")?;
    ...
    let restored_data = fs::read_to_string(decrypted_file)?;
    println!("Restored content: {}", restored_data);
