...
mod tests {
    ...
    fn test_empty_processor() {
        ...
        assert!(processor.find_by_id(1).is_none());
    }
}
...
mod tests {
    ...
    fn test_single_data_point() {
        let mut processor = DataProcessor::new();
        processor.add_data_point(42.0);
        assert_eq!(processor.calculate_mean(), Some(42.0));
        assert_eq!(processor.calculate_standard_deviation(), None);
    }
    ...
    fn test_multiple_data_points() {
        ...
        assert!((processor.calculate_standard_deviation().unwrap() - 10.0).abs() < 0.001);
    }
