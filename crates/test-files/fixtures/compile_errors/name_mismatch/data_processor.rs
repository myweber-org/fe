...
mod tests {
    ...
    fn test_data_record_validation() {
        let valid_record = DataRecord::new(1, 10.5, "test".to_string(), 1234567890);
        assert!(valid_record.is_valid());

        let invalid_id = DataRecord::new(0, 10.5, "test".to_string(), 1234567890);
        assert!(!invalid_id.is_valid());

        let invalid_value = DataRecord::new(1, f64::NAN, "test".to_string(), 1234567890);
        assert!(!invalid_value.is_valid());

        let empty_category = DataRecord::new(1, 10.5, "".to_string(), 1234567890);
    ...
    fn test_load_from_csv() {
        ...
        writeln!(temp_file, "1,10.5,category_a,1234567890").unwrap();
        writeln!(temp_file, "2,20.3,category_b,1234567891").unwrap();
