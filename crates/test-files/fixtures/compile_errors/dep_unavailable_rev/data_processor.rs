...
mod tests {
    ...
    fn test_transformations() {
        let processor = DataProcessor::new();
        assert_eq!(processor.transform("uppercase", "hello".to_string()), "HELLO");
        assert_eq!(processor.transform("trim", "  spaced  ".to_string()), "spaced");
        assert_eq!(processor.transform("reverse", "rust".to_string()), "tsur");
    }
