...
pub fn xor_encrypt_file(input_path: &str, output_path: &str, key: &[u8]) -> std::io::Result<()> {
...
pub fn xor_decrypt_file(input_path: &str, output_path: &str, key: &[u8]) -> std::io::Result<()> {
