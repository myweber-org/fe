...
mod tests {
    ...
    fn test_csv_loading() {
        ...
        writeln!(temp_file, "1,42.5,test_a,1234567890").unwrap();
        writeln!(temp_file, "2,37.8,test_b,1234567891").unwrap();
        writeln!(temp_file, "invalid,data,test_c,1234567892").unwrap();
...
mod tests {
    ...
    fn test_data_processor() {
        ...
        let csv_data = "id,value,category,timestamp\n1,42.5,category_a,1234567890\n2,37.8,category_b,1234567891\n";
        ...
        let avg = processor.calculate_average();
        assert!(avg.is_some());
        assert!((avg.unwrap() - 40.15).abs() < 0.001);
