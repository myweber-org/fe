...
mod tests {
    ...
    fn test_config_with_env() {
        ...
        let mut config = Config::new();
        config.set("TEST_CONFIG_VAR", "config_value");

        assert_eq!(config.get_with_env("TEST_ENV_VAR").unwrap(), "env_value");
        assert_eq!(config.get_with_env("TEST_CONFIG_VAR").unwrap(), "config_value");
        assert!(config.get_with_env("MISSING_VAR").is_none());
