...
mod tests {
    ...
    fn test_data_processing() {
        ...
        assert!(processor.get_data().len() <= initial_len);
    }
}
use std::error::Error;
use std::fs::File;
...
mod tests {
    ...
    fn test_data_processor() {
        ...
        writeln!(temp_file, "1,100.0,category_a,2024-01-01").unwrap();
        writeln!(temp_file, "2,200.0,category_b,2024-01-02").unwrap();
        writeln!(temp_file, "3,300.0,category_a,2024-01-03").unwrap();
...
mod tests {
    ...
    fn test_filtering() {
        ...
        processor.records.push(DataRecord::new(3, 20.1, "A"));
