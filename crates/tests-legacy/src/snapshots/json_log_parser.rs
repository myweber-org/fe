...
mod tests {
    ...
    fn test_parse_json_logs() {
        let log_data = r#"{"timestamp": "2023-10-05T14:30:00+00:00", "level": "INFO", "message": "System started", "metadata": {"user": "admin"}}
{"timestamp": "2023-10-05T14:35:00+00:00", "level": "ERROR", "message": "Connection failed", "metadata": {"retry_count": 3}}"#;
    ...
    fn test_filter_by_level() {
        let log_data = r#"{"timestamp": "2023-10-05T14:30:00+00:00", "level": "INFO", "message": "Test", "metadata": null}
{"timestamp": "2023-10-05T14:31:00+00:00", "level": "ERROR", "message": "Test", "metadata": null}"#;
    ...
    fn test_filter_by_time_range() {
        let log_data = r#"{"timestamp": "2023-10-05T14:30:00+00:00", "level": "INFO", "message": "Event 1", "metadata": null}
{"timestamp": "2023-10-05T14:45:00+00:00", "level": "INFO", "message": "Event 2", "metadata": null}"#;
        ...
        let start = FixedOffset::east_opt(0)
            .unwrap()
            .with_ymd_and_hms(2023, 10, 5, 14, 35, 0)
            .unwrap();
        let end = FixedOffset::east_opt(0)
            .unwrap()
            .with_ymd_and_hms(2023, 10, 5, 14, 50, 0)
            .unwrap();

        let filtered = parser.filter_by_time_range(start, end).unwrap();

        assert_eq!(filtered.len(), 1);
        assert_eq!(filtered[0].message, "Event 2");
    }
}