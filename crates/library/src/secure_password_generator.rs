...
mod tests {
    ...
    #[test]
    fn test_password_length() {
        let password = PasswordGenerator::new(12).generate().unwrap();
        assert_eq!(password.len(), 12);
    }

    #[test]
    fn test_custom_character_sets() {
        let password = PasswordGenerator::new(10)
            .uppercase(true)
            .lowercase(false)
            .digits(false)
            .special(false)
    ...
    #[test]
    fn test_no_character_sets() {
        let result = PasswordGenerator::new(10)
            .uppercase(false)
            .lowercase(false)
            .digits(false)
            .special(false)
    ...
    #[test]
    fn test_zero_length() {
        let result = PasswordGenerator::new(0).generate();
        assert!(result.is_err());
    }
}