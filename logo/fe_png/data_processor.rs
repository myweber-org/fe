...
impl DataProcessor {
    ...
    pub fn validate_records(&self, records: &[Vec<String>]) -> Result<(), String> {
        ...
        let expected_fields = records[0].len();
...
mod tests {
    ...
    fn test_data_processor() {
        ...
        assert!((average.unwrap() - 150.5).abs() < 0.1);
...
mod tests {
    ...
    fn test_data_processing() {
        ...
        let average = processor.calculate_average();
        assert_eq!(average, Some((10.5 + 20.3 + 15.7) / 3.0));
...
mod tests {
    ...
    fn test_process_csv() -> Result<(), Box<dyn Error>> {
        ...
        writeln!(temp_file, "3,30.7,category_c")?;
...
mod tests {
    ...
    fn test_data_processor() {
        ...
        let average = processor.calculate_average();
        assert!(average.is_some());
        assert!((average.unwrap() - 15.416666).abs() < 0.001);
